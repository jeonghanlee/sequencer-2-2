...
typedef	struct state_set_control_block *SS_ID;	/* state set id, opaque */
...
typedef void ACTION_FUNC(SS_ID ssId, USER_VAR *pVar, int transNum, short *pNextState);
typedef boolean EVENT_FUNC(SS_ID ssId, USER_VAR *pVar, short *pTransNum, short *pNextState);
...
epicsShareFunc boolean epicsShareAPI seq_efTest(SS_ID, EV_ID);
epicsShareFunc boolean epicsShareAPI seq_efClear(SS_ID, EV_ID);
epicsShareFunc boolean epicsShareAPI seq_efTestAndClear(SS_ID, EV_ID);
/* pv operations */
