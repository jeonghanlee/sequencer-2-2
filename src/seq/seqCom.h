...
typedef void ACTION_FUNC(SS_ID ssId, USER_VAR *const var, int transNum, int *nextState);
typedef seqBool EVENT_FUNC(SS_ID ssId, USER_VAR *const var, int *transNum, int *nextState);
typedef void DELAY_FUNC(SS_ID ssId, USER_VAR *const var);
typedef void ENTRY_FUNC(SS_ID ssId, USER_VAR *const var);
typedef void EXIT_FUNC(SS_ID ssId, USER_VAR *const var);
typedef void INIT_FUNC(USER_VAR *const var);
